...
1. Core Features
   ...
   Permission Management: Users set permissions on who can access their data.
...
3. Future Scaling:
   Decrentralised database for storing user files & data
...
>>>>>>> 198d0fc (Setup of Metamask and integratino with ABI)
